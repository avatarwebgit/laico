...
const validationSchema = Yup.object({
  newMessage: Yup.string().required("پیام نمی‌تواند خالی باشد"),
});
...
const ChatModal = ({
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      if (!values.newMessage.trim() || !ticket) return;

      const userMessage = { sender: "user", text: values.newMessage };
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <form className={styles.chatFooter} onSubmit={formik.handleSubmit}>
            <input
              type="text"
              name="newMessage"
