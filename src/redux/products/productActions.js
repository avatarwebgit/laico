...
export const fetchHomeProductsRequest = () => ({
  type: actionTypes.FETCH_HOME_PRODUCTS_REQUEST,
});

export const fetchHomeProductsSuccess = (products) => ({
  type: actionTypes.FETCH_HOME_PRODUCTS_SUCCESS,
  payload: products,
});

export const fetchHomeProductsFailure = (error) => ({
  type: actionTypes.FETCH_HOME_PRODUCTS_FAILURE,
  payload: error,
});
